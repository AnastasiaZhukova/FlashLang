...
public class SignInOperation implements IOperation<Void> {

    private final String mEmail;
    private final String mPassword;
    private final ICallback<User> mCallback;

    public SignInOperation(final String pEmail, final String pPassword, final ICallback<User> pCallback) {
        mEmail = pEmail;
        mPassword = pPassword;
        mCallback = pCallback;
    }
    ...
    public Void perform() throws Exception {
        ...
        userManager.signIn(request, new IFirebaseUserManager.IAuthCallback() {

package com.github.anastasiazhukova.flashlang.ui.fragment.auth;
...
public class SignUpFragment extends BaseAuthFragment implements View.OnClickListener {
    ...
    private AuthContract.Presenter.ISignUpPresenter mPresenter;
    ...
    public void attachPresenter(final AuthContract.Presenter.ISignUpPresenter pPresenter) {
    ...
    public View onCreateView(@NonNull final LayoutInflater pInflater, @Nullable final ViewGroup pContainer, @Nullable final Bundle pSavedInstanceState) {
        final ViewGroup rootView = (ViewGroup) pInflater.inflate(R.layout.fragment_signup, pContainer, false);
        return rootView;
    }
    ...
    public void onViewCreated(@NonNull final View pView, @Nullable final Bundle pSavedInstanceState) {
        ...
        pView.findViewById(R.id.sign_up_button).setOnClickListener(this);
    }
